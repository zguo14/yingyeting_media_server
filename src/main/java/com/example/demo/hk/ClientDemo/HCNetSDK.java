...
import com.example.demo.hk.CommonKit;
...
//NET_DVR_Login()参数结构
	...
	public static class NET_DVR_PREVIEWINFO extends Structure {
		...
		public HWND     hPlayWnd;
		boolean     bBlocked;
		boolean     bPassbackRecord;
		byte     byPreviewMode;
//		byte     byStreamID[STREAM_ID_LEN];
		byte     byProtoType;
		byte      byRes1;
		byte     byVideoCodingType;
		public NativeLong   dwDisplayBufNum;
		byte      byNPQMode;
//		byte     byRes[215];
	}
	...
	boolean NET_DVR_SaveRealData_V30(NativeLong key, int STREAM_TYPE, String fileName);
